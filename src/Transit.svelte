<script>
  ...
  <h3>Metro Transit Police Department</h3>
  
  <h4 class="source">Data sources: Metropolitan Council</h4>
  
  <div><p>The Metro Transit Police Department (MTPD) is a service of the Metropolitan Council.</p></div>
  ...
  <h4>Links</h4>
  <ul>
    <li><a href="https://www.metrotransit.org/police">Metro Transit Police Department</a></li>
    <li><a href="https://www.metrotransit.org/performance">Metro Transit Police Statistics</a></li>
  </ul>
