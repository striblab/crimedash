<script>
    ...
    import stpViolentCrime from '../../store/stpv/stp_violent.json';
...
<div class="download"><a href="../../store/stpv/stp_violent.csv">Download St. Paul 1985-2023 violent crimes data (includes clearances)</a></div>
