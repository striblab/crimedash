<script>
    ...
    import stpProperty from '../../store/stpf/stp_arson.json';
    ...
    onMount(() => {
        ...
        propertyChart = createChart(ctxProperty, stpProperty, 'Arsons');
    });
  </script>
...
<p>Arson rates in St. Paul have have fallen over time before surging during the pandemic.</p>

<div class="chart-container">
    <canvas id="propertyChart"></canvas>
  </div>
<div class="download"><a href="../store/stpf/stp_arson.csv">Download St. Paul 1985-2023 arson data (includes clearances)</a></div>
