<script>
	...
	import Murder from './MPLS/Murder.svelte';
	import Manslaughter from './MPLS/Manslaughter.svelte';
	import Justified from './MPLS/Justified.svelte';
	import Gunfire from './MPLS/Gunfire.svelte';
	import Shotvictims from './MPLS/Shotvictims.svelte';
	import Assault from './MPLS/Assault.svelte';
	import Domestic from './MPLS/Domestic.svelte';
	import Rape from './MPLS/Rape.svelte';
	import Robbery from './MPLS/Robbery.svelte';
	import Carjack from './MPLS/Carjack.svelte';
	import Autotheft from './MPLS/Autotheft.svelte';
	import Burglary from './MPLS/Burglary.svelte';
	import Larceny from './MPLS/Larceny.svelte';
	import Arson from './MPLS/Arson.svelte';
	import Drugs from './MPLS/Drugs.svelte';
	import Other from './MPLS/Other.svelte';
	import Activity from './MPLS/Activity.svelte';
	import Precincts from './MPLS/Precincts.svelte';
	...
	import STPS from './STP/STPS.svelte';
	import STPAT from './STP/STPAT.svelte';
	import STPR from './STP/STPR.svelte';
	import STPSA from './STP/STPSA.svelte';
	import STPL from './STP/STPL.svelte';
	import STPA from './STP/STPA.svelte';
	import STPPA from './STP/STPPA.svelte';
	import STPN from './STP/STPN.svelte';
	import UMPD from './METRO/UMPD.svelte';
	import MSP from './METRO/MSP.svelte';
	import Transit from './METRO/Transit.svelte';
	import Hennepin from './METRO/Hennepin.svelte';
	import Ramsey from './METRO/Ramsey.svelte';
	import Anoka from './METRO/Anoka.svelte';
	import Scott from './METRO/Scott.svelte';
	import Carver from './METRO/Carver.svelte';
	import Dakota from './METRO/Dakota.svelte';
	import Washington from './METRO/Washington.svelte';
	import Statewide from './MN/Statewide.svelte';
	...
	import Practices from './SECTIONS/Practices.svelte';
