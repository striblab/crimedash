---
title: "Star Tribune public safety dashboard"
...
csvcopy <- function(filename, crime){
  ...
  destination_path <- file.path(current_working_dir, "..", "public", crime, filename)
...
```{r}
categories <- c('Gunshot Wound Victims', 'Shooting (PFE)', 
                'Shooting Report Only (P)', 'ShotSpotter Activation (P)',  'Sound of Shots Fired (P)')
...
download_arrest_reports <- function() {
  base_path <- "/Users/hargaja/Desktop/workspace/redboard/20240428-crimedash/public/arrests"
  urls <- c(
 ...
 map(urls, function(url) {
    ...
    file_name <- paste0(file_name, ".csv")  # Append '.xlsx' extension to the file name
